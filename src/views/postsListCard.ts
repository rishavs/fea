...
<li class="group flex flex-col rounded-box border border-base-300 bg-base-100 shadow-lg">
    <div class="flex p-1 lg:p-4">
      ...
      <div class="flex grow pl-2 lg:px-4 lg:pl-4">
        <div class="flex flex-col justify-between">
          ...
          <p class="flex items-center gap-1 py-1 text-xs lg:py-4 lg:text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-3 lg:size-4 opacity-60" fill="currentColor" viewBox="0 0 512 512">
              <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
              <path d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
            </svg>
            <span class="opacity-60"> 12H</span> &nbsp;

            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-3 lg:size-4 opacity-60" viewBox="0 0 512 512">
              <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="size-3 lg:size-4 opacity-60" viewBox="0 0 448 512">
              <!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
              <path d="M304 128a80 80 0 1 0 -160 0 80 80 0 1 0 160 0zM96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128zM49.3 464l349.5 0c-8.9-63.3-63.3-112-129-112l-91.4 0c-65.7 0-120.1 48.7-129 112zM0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3z" />
            </svg>
            <a class="link link-info link-hover line-clamp-1">Count Dingus Berrius the third</a>
          </p>
      ...
      <div class="tooltip before:delay-500! after:delay-500!" data-tip="hello">
        <span class="btn btn-circle btn-xs btn-ghost lg:btn-md">
    ...
    <div class="mx-1 mb-1 lg:mx-4 lg:mb-4 rounded-box border border-base-300 bg-base-200 shadow-inner">
      <div class="m-1 flex justify-between rounded-box bg-base-100 shadow">
        <div class="join">
          ...
          <a class="btn h-auto link rounded-none btn-xs link-hover opacity-60 btn-ghost lg:btn-md">#Tech</a>
          <a class="btn h-auto link rounded-none btn-xs link-hover opacity-60 btn-ghost lg:btn-md">#Humour</a>
        </div>
        ...
        <div class="float-end join">
          ...
          <a class="btn w-18 link rounded-box rounded-l-none btn-sm link-hover btn-error btn-soft lg:w-48 lg:btn-md">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="size-4 lg:size-6" viewBox="0 0 320 512" fill="currentColor"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
          </a>
        </div>
      </div>
    </div>
