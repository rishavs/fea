...
<div class="navbar-end flex gap-2 items-center">
    ...
    <!-- New -->
    <a data-role="signedin_controls" href="/p/new" class="btn btn-square hidden">
    ...
    <!-- Identity Controls -->
    <div data-role="signedin_controls" class="dropdown dropdown-end hidden">
        <label tabindex="0" class="btn btn-square flex items-center overflow-hidden lg:btn-md hover:underline">
            <img data-role="user-profile-img" class="" src="" />
        </label>
        <ul tabindex="0" class="z-20 shadow menu menu-lg dropdown-content bg-base-100 border-base-300 rounded-box mt-2">
            <li>
                <a class="" id="user_profile_action">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
