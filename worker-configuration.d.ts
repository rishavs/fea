/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 766595e499ace3b3375c431b3eccb0a8)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		IMAGE_HOST: string;
		LOCAL_DB_URI: string;
		CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_POSTGRES: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "IMAGE_HOST" | "LOCAL_DB_URI" | "CLOUDFLARE_HYPERDRIVE_LOCAL_CONNECTION_STRING_POSTGRES">> {}
}
